...
conn = mysql.connector.connect(user = 'root', host = 'localhost', database = 'twitter_api', charset = 'utf8mb4')
curseur = conn.cursor()

sql = 'SELECT `place`,`latitude`,`longitude`,`user_name` FROM tweet_geo'
